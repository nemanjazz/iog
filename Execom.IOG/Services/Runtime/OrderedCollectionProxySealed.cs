// -----------------------------------------------------------------------
// <copyright file="OrderedCollectionProxySealed.cs" company="Execom">
...
namespace Execom.IOG.Services.Runtime
{
    ...
    /// <summary>
    /// Generic proxy definition for ordered collections of sealed elements which we already know the element type.
    /// </summary>
    /// <typeparam name="TElementType">Type of collection element</typeparam>
    /// <author>Nenad Sabo</author>
    internal class OrderedCollectionProxySealed<TElementType> : IOrderedCollection<TElementType>
    {
        ...
        public OrderedCollectionProxySealed(IRuntimeProxyFacade facade, Guid instanceId, Boolean readOnly)
        {
        ...
        public void Add(TElementType item)
        {
            ...
            __facade__.CollectionAddOrdered(__instanceId__, elementTypeId, item, isScalar);
        }
