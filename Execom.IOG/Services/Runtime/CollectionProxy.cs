// -----------------------------------------------------------------------
// <copyright file="CollectionProxy.cs" company="Execom">
...
namespace Execom.IOG.Services.Runtime
{
    ...
    /// <summary>
    /// Generic proxy definition for collections of elements which may have descendants
    /// </summary>
    /// <typeparam name="TElementType">Type of collection element</typeparam>
    /// <author>Nenad Sabo</author>
    internal class CollectionProxy<TElementType> : IIndexedCollection<TElementType>
    {
        ...
        public CollectionProxy(IRuntimeProxyFacade facade, Guid instanceId, Boolean readOnly)
        {
        ...
        public void Add(TElementType item)
        {
            ...
            __facade__.CollectionAdd(__instanceId__, Guid.Empty, item, isScalar);
        }
        ...
        {
            return __facade__.CollectionTryFindPrimaryKey(Guid.Empty, __instanceId__, isScalar, IsReadOnly, key, out value);
        }

        public TElementType FindByPrimaryKey(object key)
        {
            return __facade__.CollectionFindByPrimaryKey<TElementType>(Guid.Empty, __instanceId__, isScalar, IsReadOnly, key);
        }
