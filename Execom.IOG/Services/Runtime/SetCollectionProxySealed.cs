// -----------------------------------------------------------------------
// <copyright file="SetCollectionProxySealed.cs" company="Execom">
...
namespace Execom.IOG.Services.Runtime
{
    ...
    /// <summary>
    /// Generic proxy definition for set of sealed elements which we already know the element type.
    /// </summary>
    /// <typeparam name="TElementType">Type of collection element</typeparam>
    /// <author>Nenad Sabo</author>
    internal class SetCollectionProxySealed<TElementType> : IScalarSet<TElementType>
    {
        ...
        public void Add(TElementType item)
        {
            ...
            __facade__.SetAdd(__instanceId__, elementTypeId, item, isScalar);
        }
