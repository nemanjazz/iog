// -----------------------------------------------------------------------
// <copyright file="SetCollectionProxy.cs" company="Execom">
...
namespace Execom.IOG.Services.Runtime
{
    ...
    /// <summary>
    /// Generic proxy definition for set of elements which may have descendants
    /// </summary>
    /// <typeparam name="TElementType">Type of collection element</typeparam>
    /// <author>Nenad Sabo</author>
    internal class SetCollectionProxy<TElementType> : IScalarSet<TElementType>
    {
        ...
        public SetCollectionProxy(IRuntimeProxyFacade facade, Guid instanceId, Boolean readOnly)
        {
        ...
        public void Add(TElementType item)
        {
            ...
            __facade__.SetAdd(__instanceId__, Guid.Empty, item, isScalar);
        }
        ...
        {
            return __facade__.SetContains(__instanceId__, item, isScalar, __readOnly__);
        }
        ...
        public bool Remove(TElementType item)
        {
            ...
            return __facade__.SetRemove(__instanceId__, item, isScalar);
        }
