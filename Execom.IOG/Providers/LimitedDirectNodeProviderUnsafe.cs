...
namespace Execom.IOG.Providers
{
    ...
    internal class LimitedDirectNodeProviderUnsafe<TIdentifier, TNodeData, TEdgeData> : IEvictingProvider<TIdentifier>, INodeProvider<TIdentifier, TNodeData, TEdgeData> where TEdgeData : IComparable<TEdgeData>
    {
        /// <summary>
        /// Underlying storage
        /// </summary>
        ...
        public LimitedDirectNodeProviderUnsafe(IKeyValueStorage<TIdentifier, object> storage, bool forceUpdate)
        {
