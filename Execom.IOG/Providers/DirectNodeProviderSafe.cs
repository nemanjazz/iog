...
namespace Execom.IOG.Providers
{
    ...
    [Serializable]
    internal class DirectNodeProviderSafe<TIdentifier, TNodeData, TEdgeData> : INodeProvider<TIdentifier, TNodeData, TEdgeData> where TEdgeData : IComparable<TEdgeData>
    {
        /// <summary>
        /// Underlying storage
        /// </summary>
        ...
        public DirectNodeProviderSafe(IKeyValueStorage<TIdentifier, object> storage, bool forceUpdate)
        {
