namespace execom.iog.name, (exports) ->
  class exports.CollectionProxySealed
    ...
    constructor: (@__facade__, @__instanceId__, @__readOnly__, @type) ->
      ...
      @genericArgumentTypeId = exports.StaticProxyFacade.get().GetTypeId(
        @genericArgumentType)
      @isScalar = exports.StaticProxyFacade.get().IsScalarType(
        @genericArgumentTypeId)
    ...
    Add: (item) ->
      ...
      @__facade__.CollectionAdd(@__instanceId__, @genericArgumentTypeId, item,
        @isScalar)
    ...
    CopyTo: ( array, arrayIndex) ->
      @__facade__.CollectionCopyTo(@genericArgumentTypeId, @__instanceId__, 
    ...
    TryFindPrimaryKey: (key) ->
      rez = @__facade__.CollectionTryFindPrimaryKey(@genericArgumentTypeId, 
