namespace execom.iog.name, (exports) ->
  class exports.DictionaryProxySealed
    ...
    Add: (key, value) ->
      ...
      if(not value? and key.hasOwnProperty(DictionaryProxySealed.KEY) and  key.hasOwnProperty(DictionaryProxySealed.VALUE))
      ...
      @__facade__.DictionaryAdd(@__instanceId__, 
        exports.StaticProxyFacade.get().GetTypeId(@type.genericArguments[1]), 
        @isScalar, newKey, newValue)
      return
    ...
    # array is array of javascripts objects, 
    # where every object has properties key and value
    ...
    GetEnumerator: () ->
      return @__facade__.DictionaryGetEnumerator(@__instanceId__, 
        exports.StaticProxyFacade.get().GetTypeId(@type.genericArguments[1]),
          @isScalar, @__readOnly__, @keyIsScalar)